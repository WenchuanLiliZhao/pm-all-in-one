...
Future extract to a domain repo: only when a second host, publish artifact, or stable plugin API appears — propose via `/propose-repo`, not a return to `space/packages/`.
