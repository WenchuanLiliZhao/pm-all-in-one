 ...
 *
 * ↔ electron/core/detail-diff.ts — OCC expected / StaleWriteError on updateHandoff
...
import { allocateHandoffId, handoffsRoot, hierarchyRoot } from "./ids.js";
import { memberDirPath } from "./members.js";
import { loadHandoffProps, writePropsTs } from "./props-load.js";
