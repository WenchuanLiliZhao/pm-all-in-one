...
| `detailHeader↔detail-body` | horizontal pad of detail chrome | `workspace-page` · `.detailHeader` | `issue-detail` / `project-detail` · `.root` | header: 12 · body: 12 (was 14) | aligned | `--space--12` |
