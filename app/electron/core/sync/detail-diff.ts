 ...
 * ↔ electron/core/domain/wiki.ts — wiki OCC via WikiEditableSlice
 * ↔ electron/core/domain/members.ts — member OCC via MemberEditableSlice
 * ↔ electron/core/domain/handoffs.ts — handoff OCC via HandoffEditableSlice
 * Shared via @pm-core/sync/detail-diff (not a third bridge).
 */
